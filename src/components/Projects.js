            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-lg-4 mb-3 d-flex align-items-stretch">
                  <div class="card">
                    <img src="../7.png" class="card-img-top" alt="Card Image" />
                    <div class="card-body d-flex flex-column">
                      <h5 class="card-title">Portfolio Website</h5>
                      <p class="card-text mb-4">A React based website designed and built from the ground up.</p>
                      <a href="#" class="btn btn-secondary mt-auto align-self-start">Project</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 mb-3 d-flex align-items-stretch">
                  <div class="card">
                    <img src="../CS50.png" class="card-img-top" alt="Card Image" />
                    <div class="card-body d-flex flex-column">
                ...
                <div class="col-lg-4 mb-3 d-flex align-items-stretch">
                  <div class="card">
                    <img src="../Lilly.png" class="card-img-top" alt="Card Image" />
                    <div class="card-body d-flex flex-column">
